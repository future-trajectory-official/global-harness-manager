...
description: スプリント終了時に、実績とセッション振り返りを確認してスプリントの評価を記録する。実績確認と5指標の採点・評価は本スキル内の対話で確定し、振り返りへ永続化する。
tags:
...
**責務の境界**: 本スキルはスプリント終了時点の実績とセッション振り返りに基づき、5指標の評価を
POとの対話で確定し、対象スプリントの振り返りへ**永続化（記録）**する役割を担います。
