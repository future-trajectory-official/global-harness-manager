...
- **期待される結果（終了条件）**:
  ...
  4. ProjectV2のボードで構造を確認できる旨をPOに伝えていること。
...
## Phase 4: スプリント開始 (Sprint Kickoff)
...
## Phase 6: 受入基準（AC）とエッジケースの定義 (AC Definition)
