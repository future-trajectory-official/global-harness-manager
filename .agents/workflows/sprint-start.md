...
- **読み込むペルソナ**: `.agents/rules/po-coach.md` (POコーチ) および
  `.agents/rules/scrum-master.md` (スクラムマスター)
- **実行するスキル**: `product-backlog-refinement`
- **入力（前提条件）**: 最新の `product-backlog.md` および `epic-master.md`。
- **手続き**:
...
- **読み込むペルソナ**: `.agents/rules/scrum-master.md` (スクラムマスター)
...
- **読み込むペルソナ**:
  - `.agents/rules/tester.md` (テスト/品質保証)
  - `.agents/rules/refactor.md` (可読性・保守性・技術負債削減)
  - `.agents/rules/documentation-writer.md` (明確で資産となるドキュメント執筆)
