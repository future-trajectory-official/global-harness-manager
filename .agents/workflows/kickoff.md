...
- **読み込むペルソナ**: `.agents/rules/investor.md` (エンジェル投資家)
...
- **読み込むペルソナ**: `.agents/rules/po-coach.md` (POコーチ)
- **実行するスキル**: `craft-vision`
- **終了条件**: ユーザーがステートメントに合意し、`VISION.md` が生成されること。
...
- **終了条件**: `product-backlog.md`（ゴールセクション）と `epic-master.md` の骨格が生成されること。
...
- **読み込むペルソナ**: `.agents/rules/technical-advisor.md` (技術顧問)
...
- **読み込むペルソナ**: `.agents/rules/devils-advocate.md` (悪魔の代弁者)
