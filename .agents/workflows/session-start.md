...
- **ロール**: `[scrum-master.md](file://.agents/rules/scrum-master.md)` (進行役として開始)
- **実行スキル**:
  `[verify-vision-capability](file://.agents/skills/bundles/management-bundle/verify-vision-capability/SKILL.md)`
- **成果物**: 「Vision & Capability Alignment Report」
- **セルフチェック**:
  - [ ] **[価値基準]** `[VISION.md](file://.agents/management/VISION.md)`
...
- **ロール**: `[scrum-master.md](file://.agents/rules/scrum-master.md)` (優先順位の調整)
- **実行スキル**:
  `[identify-session-task](file://.agents/skills/bundles/management-bundle/identify-session-task/SKILL.md)`
...
- **ロール**: 指名された専門家
- **実行スキル**:
  `[session-planning](file://.agents/skills/bundles/management-bundle/session-planning/SKILL.md)`
...
- **ロール**: `[scrum-master.md](file://.agents/rules/scrum-master.md)` (最終確認)
- **セルフチェック**:
