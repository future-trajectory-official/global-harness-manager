...
echo '{"title":"<WP-title>","body":"<description>","parentNumber":<parent-issue-number>}' | deno run -A .agents/skills/bundles/management-bundle/github-wp-create/scripts/github-wp-create.ts --repo "<owner>/<repo>" --label-prefix "<prefix>" --dry-run
```
