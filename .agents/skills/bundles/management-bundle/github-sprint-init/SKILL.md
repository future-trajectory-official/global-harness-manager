...
```bash
echo '{"title":"Sprint 12","description":"AIガバナンス強化スプリント","dueOn":"2026-06-30"}' \
  | deno run -A .agents/skills/bundles/management-bundle/github-sprint-init/scripts/github-sprint-init.ts \
