...
echo '{"milestone":"<sprint-title>"}' | deno run -A .agents/skills/bundles/management-bundle/github-sprint-velocity-record/scripts/github-sprint-velocity-record.ts --repo "<owner>/<repo>" --dry-run
```
