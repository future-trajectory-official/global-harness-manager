...
```bash
echo '{"number":42,"addLabels":["status:in-progress"],"removeLabels":["status:idea"]}' \
  | deno run -A .agents/skills/bundles/management-bundle/github-pbi-update/scripts/github-pbi-update.ts \
