...
echo '{"milestone":"<sprint-title>","state":"open"}' | deno run -A .agents/skills/bundles/management-bundle/github-sprint-review-plan/scripts/github-sprint-review-plan.ts --repo "<owner>/<repo>" --label-prefix "<prefix>" --dry-run
```
