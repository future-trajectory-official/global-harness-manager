import { logger, pathUtil, fsUtil, executeCommand, mdUtil, errorUtil } from "../../../core/harness-core.ts";
...
async function processProject(project: {
  ...
  try {
    ...
    await executeCommand({ cmd: "git", args: ["config", "user.name", project.account], cwd: resolvedPath, dryRun: isDryRun });
    await executeCommand({ cmd: "git", args: ["config", "user.email", project.email], cwd: resolvedPath, dryRun: isDryRun });
